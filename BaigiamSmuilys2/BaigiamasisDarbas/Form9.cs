...
namespace BaigiamasisDarbas
{
    public partial class Form9 : Form
    {
        ...
        const string Cfd3 = "sandeliai.txt";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dataGridView1.Rows.Add(this.comboBox1.Text, this.comboBox2.Text, this.comboBox3.Text, this.textBox1.Text, this.textBox2.Text, this.textBox3.Text, this.textBox4.Text);
                comboBox1.Text = "";
                //comboBox2.Text = "";
                //comboBox3.Text = "";
                textBox1.Text = "";
